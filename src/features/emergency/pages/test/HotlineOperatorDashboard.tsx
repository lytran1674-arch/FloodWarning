...
// // ── Type cho active call workflow ──
// interface ActiveResult {
//   initialCallTask: UpdateCallTaskResponse
//   sos: { id: string; trackingCode: string }
// }
...
//   // ✅ Khai báo activeResult — null = đang ở màn dashboard, có giá trị = đang trong call workflow
...
export default function HotlineOperatorDashboard() {
  ...
  const handleCreated = (result: SosHotlineCreateResult) => {
    setSelectedCallEventId(null)
    setManualModalOpen(false)
    // ✅ result.initialCallTask luôn có type CallTaskData đúng
    setActiveResult(result)
  }
