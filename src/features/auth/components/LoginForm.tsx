...
export const LoginForm: React.FC = () => {
  ...
  password,
      ...
      const { token, role, authenticated,hoten,id ,areaId,teamId,teamName,isLeader,sodt} = res.data.result
  console.log("LOGIN RESULT:", res.data.result);
      ...
      // ✅ Lưu token vào Redux
      dispatch(setCredentials({ user: { role,hoten,id,areaId,teamId,teamName,isLeader,sodt}, token}))
