...
import { Send, ShieldCheckIcon } from "lucide-react";
          ...
          <form onSubmit={handleForgotPassword}>
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              >
                ...
                để nhận hướng dẫn mở khóa tài khoản
              </p>
            </div>
...
>
    <Send/>
  {loading ? "Đang gửi..." : "Gửi liên kết mở khóa"}
</Button>
            {/* Back */}
            <div
              className="
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <p className="text-gray-700 text-sm mt-1 leading-5">
                 Không nhận được email? Kiểm tra thư rác hoặc vui lòng thử lại sau.
                </p>
              </div>
            </div>
          </form>
